...
def upgrade() -> None:
    ...
    # Drop all tables first (using IF EXISTS to avoid transaction abort)
    op.execute("DROP TABLE IF EXISTS device_logs CASCADE")
    op.execute("DROP TABLE IF EXISTS alerts CASCADE")
    op.execute("DROP TABLE IF EXISTS images CASCADE")
    op.execute("DROP TABLE IF EXISTS journey_sessions CASCADE")
    ...
    op.execute("DROP TYPE IF EXISTS imagetypeenum CASCADE")
